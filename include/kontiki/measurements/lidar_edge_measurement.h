...
public:
  ...
  Eigen::Matrix<double, 3, 1> Point2Line(const type::Trajectory<TrajectoryModel, double> &trajectory) const {
    Eigen::Matrix<double, 3, 1> dist = calculatePoint2Line<TrajectoryModel, double>(trajectory, *lidar_);
    return dist;
  }
